            ...
            <div style={{ position: 'absolute', top: '0', width: '100%', zIndex: -1}} className='d-flex flex-column flex-wrap justify-content-center align-items-center' id='showBig'>
                <div style={{ height: '100vh', width: '100%', backgroundColor: 'white' }}>
                    <div style={{ marginTop: '30vh' }}>
                        <p style={{ fontSize: '80px', fontWeight: '700', textAlign: 'center'}}>welcome to studyflow.ai</p>
                        <p style={{ fontSize: '55px', textAlign: 'center', marginBottom: '100px' }} className="mb-2 text-muted">automated workflow for students</p>
                ...
                <div style={{ zIndex: '-10', height: '500px' }}>
                    <div style={{ position: 'absolute', right: '1px'}}>
                        <p style={{ fontSize: '100px', textAlign: 'center', fontWeight: '700' }}>
                ...
                <div style={{ backgroundColor: 'white', height: '800px'}}>
                    <p style={{ fontSize: '80px', textAlign: 'center', fontWeight: '700', marginTop: '100px' }}>
